...
# Base class for storing and formatting data as a string
class Field:
...
# Class for storing name and removing extra spaces
class Name(Field):
    def __init__(self, value):
...
# Class for storing and validating birthday
...
# Main class for contact records
class Record:
...
# Dictionary-like class to store contact records
